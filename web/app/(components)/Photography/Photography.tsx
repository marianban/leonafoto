  ...
  return (
    <section className="photography">
      <div className="content">
        <h2 id="fotenie">Ako prebieha fotenie?</h2>
        <p>
          ...
          niektoré vekové kategórie detí aj oblečenie.
        </p>
        <p>
          Odporúčam obliecť si jednofarebné, málo výrazné oblečenie bez nápisov,
          obrázkov a vzorov, pretože na fotografiách vyniknú najlepšie neutrálne
          kúsky oblečenia (biela, béžová nikdy nič nepokazí). Pri deťoch sa
          jednoduchý štýl oblečenia dá oživiť veselými a hravými kúskami a
          doplnkami, a je na vás či chcete vyskúšať počas fotenia aj viac
          outfitov.
        </p>
        <p>
          V ateliéri je k dispozícii priestranná predsieň s veľkým zrkadlom na
          prezliekanie a úpravy pred fotením, toaleta a veľká sedačka v
          miestnosti fotenia. Po nafotení odosielam náhľad fotiek na výber
          prostredníctvom emailu. Po výbere fotiek na úpravu si vyhradzujem čas
          v rozmedzí 7-10 dní odo dňa prijatia platby. Platba je možná
          hotovostne alebo bezhotovostne (prevodom na účet) podľa aktuálneho
          cenníka. Údaje k úhrade platby na účet vždy obdržíte do emailu.
        </p>
        <p>
